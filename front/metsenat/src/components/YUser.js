...
function MyVerticallyCenteredModal(props) {
  return (
    ...
    >
      ...
      <Modal.Body>
        <HomiyWrapper>
          <div className="d-flex yuserTah mt-2">
          ...
          <div className="userTah mb-4">
            ...
            <div>
              <p className="mb-2 modTitle">tashkilot nomi</p>
              <input
                type="number"
          ...
          <div>
            <div className="quiz">
              ...
              <div className="d-flex mt-4">
                ...
                <div className="ms-5">
                  <p className="quizBot m-0 mb-2">Tashkilot nomi</p>
                  <p className="quizNum">Orient Group Corpation</p>
                </div>
              </div>
            </div>
            <img src={quizImg} alt="" />
